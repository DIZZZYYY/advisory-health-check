        ...
        with st.spinner("Fetching data from Xero..."):
            try:
                headers = {
                    ...
                    "Xero-Tenant-Id": "",
                    "Accept": "application/json"          # ← This is the important fix
                }
                ...
                # Fetch Reports with JSON format
                ...
                if bs_resp.ok and pl_resp.ok:
                    ...
                    # Debug: Show raw data structure temporarily
                    st.write("**📋 Raw Balance Sheet Data Structure:**")
                    st.json(bs_data)
                    
                    st.write("**📋 Raw P&L Data Structure:**")
                    st.json(pl_data)
